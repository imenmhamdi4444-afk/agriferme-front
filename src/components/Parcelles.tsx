  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 15, padding: 20 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
        <SearchBar value={search} onChange={v => { setSearch(v); setPage(1); }} placeholder='Rechercher une parcelle...' />
        <span style={{ fontSize: 13, color: '#7f8c8d' }}>{filtered.length} parcelle(s)</span>
      </div>
